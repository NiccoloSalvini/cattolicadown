...
university: Catholic University of Sacred Heart (, sede)
university-logo: templates/cattolica-logo.pdf
university-logo-width: 5cm
submitted-text: A thesis submitted for the degree of
degree: MSc in Statistical and Actuarial Sciences
degreedate: 5th July 2022
...
output:
  ...
  bookdown::bs4_book: 
    ...
    theme:
      primary: "#043b5f"
    includes:
        in_header: templates/hypothes.html
    repo: https://github.com/NiccoloSalvini/cattolicadown
    pandoc_args: "--lua-filter=scripts_and_filters/colour_and_highlight.lua"
  bookdown::gitbook:
